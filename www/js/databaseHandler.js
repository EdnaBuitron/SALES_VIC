           ...
           //fin SURO2
            ...
            if(empresa == "sales_suro"){
               ...
               tx.executeSql(
                ...
                //vic 2
                tx.executeSql(
                   "create table if not exists datosVIC_SS(id_datos integer primary key, id_cedula integer, foto_inicio blob, id_cliente text, nombre_cliente text, nombre_comercial text, nombre_contacto text , telefono text, correo text, estatus_cliente text, firma_cliente blob, foto_salida blob, observaciones_generales text, estado_cuenta text, tipo_visita text, permite_almacen text, persona_cuenta text, correo_cuenta text,pregunta_equipo text, pregunta_img text, pregunta_entrena text, pregunta_pedido text)",
                   [],
                   function(tx, results){
                    //    console.log("Se creo APOYO VIC correctamente!");
                   },
                ...
                tx.executeSql(
                    "create table if not exists equiposVIC_SS(id_equipos integer primary key, id_cedula integer, estado text, descripcion text, equipo text, cantidad integer, ubicacion text, motivo text, comentarios text, foto blob, fecha text)",
                    [],
                    function(tx, results){
                     //    console.log("Se creo APOYO VIC correctamente!");
                    },
                ...
                tx.executeSql(
                    "create table if not exists imagenVIC_SS(id_imagen integer primary key, id_cedula integer, tipo integer, estado text, cantidad integer, ubicacion text, comentarios text,  foto blob, fecha text)",
                    [],
                    function(tx, results){
                     //    console.log("Se creo APOYO VIC correctamente!");
                    },
                ...
                tx.executeSql(
                    "create table if not exists entrenaVIC_SS(id_entrena integer primary key, id_cedula integer, tipo integer, persona_capacita text, puesto_capacita text, tema_capacita text, comentarios text, foto blob, fecha text)",
                    [],
                    function(tx, results){
                     //    console.log("Se creo APOYO VIC correctamente!");
                    },
                ...
                tx.executeSql(
                    "create table if not exists almacenVIC_SS(id_almacen integer primary key, id_cedula integer, observaciones text, foto blob, fecha text)",
                    [],
                    function(tx, results){
                     //    console.log("Se creo APOYO VIC correctamente!");
                    },
                ...
                tx.executeSql(
                    "create table if not exists pedidosVIC_SS(id_producto integer primary key, id_cedula integer, producto text, codigo text, descripcion text, inventario_dia text, cantidad_solicitada integer, comentarios text)",
                    [],
                    function(tx, results){
                     //    console.log("Se creo APOYO VIC correctamente!");
                    },
                ...
                tx.executeSql(
                   "create table if not exists equiposCargados_SS(id_equipo integer primary key, id_cliente text, codigo text, descripcion text, id_usuario int, enviado int)",
                   [],
                   function(tx, results){
                    //    console.log("Se creo APOYO VIC correctamente!");
                   },
                ...
                tx.executeSql(
                    "Create table if not exists VIC_Fotos_SS(ID_Fotos integer primary key,ID_Cedula integer,pregunta integer,FechaHora text,Foto blob,orden text)",
                    [],
                    function(tx,results){
                       //   console.log("Se creo VIC_Fotos correctamente!")
                    },
                ...
                tx.executeSql(
                    "Create table if not exists VIC_Respuesta_SS(id_respuesta integer primary key, id_cedula integer,orden integer,id_pregunta integer, respuesta text,recomendacion text,fecha text,obligatorio integer,factor text)",
                    [],
                    function(tx,results){
                       //   console.log("Se creo VIC_Respuesta correctamente!")
                    },
